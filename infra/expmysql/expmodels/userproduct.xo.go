...
func (up *UserProduct) Insert(ctx context.Context, db XODB) error {
	var err error
	...
	_, err = db.ExecContext(ctx, sqlstr, up.UserProductID, up.UserID, up.Title, up.Description, up.CreatedAt, up.UpdatedAt)
	if err != nil {
		return err
	}
...
func (up *UserProduct) Update(ctx context.Context, db XODB) error {
	var err error
	...
	_, err = db.ExecContext(ctx, sqlstr, up.UserID, up.Title, up.Description, up.CreatedAt, up.UpdatedAt, up.UserProductID)
	return err
}

// Save saves the UserProduct to the database.
func (up *UserProduct) Save(ctx context.Context, db XODB) error {
	if up.Exists() {
...
func (up *UserProduct) Delete(ctx context.Context, db XODB) error {
	var err error
	...
	_, err = db.ExecContext(ctx, sqlstr, up.UserProductID)
	if err != nil {
		return err
	}
...
func (up *UserProduct) User(ctx context.Context, db XODB) (*User, error) {
...
func UserProductsByUserID(ctx context.Context, db XODB, userID string) ([]*UserProduct, error) {
	var err error
	...
	// run query
	XOLog(sqlstr, userID)
	q, err := db.QueryContext(ctx, sqlstr, userID)
	if err != nil {
		return nil, err
	}
	defer func() {
...
func UserProductsByTitle(ctx context.Context, db XODB, title string) ([]*UserProduct, error) {
	var err error
...
func UserProductByUserProductID(ctx context.Context, db XODB, userProductID string) (*UserProduct, error) {
	var err error
	...
	err = db.QueryRowContext(ctx, sqlstr, userProductID).Scan(&up.UserProductID, &up.UserID, &up.Title, &up.Description, &up.CreatedAt, &up.UpdatedAt)
	if err != nil {
		return nil, err
	}
